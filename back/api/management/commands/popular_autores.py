        ...
        if opts["update"]: 
            ...
            for row in df.itertuples(index=False):
                ...
                obj, created = Autor.objects.update_or_create(
                    ...
                    #   Autor(autor="Jorge", s_autor="Amado", nasc="1912-08-10", nacio="Brasileira", biogr="...")
                    # Se no CSV vem:
                    #   Jorge,Amado,1912-08-10,Brasileira,Autor famoso
                    # O Django encontra esse autor pelo trio (autor, s_autor, nasc).
                    #    Atualiza biogr para "Autor famoso".
                    #    created = False.
                if created:
                    criados += 1
                else:
